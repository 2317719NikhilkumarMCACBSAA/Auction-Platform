...
const SignUp = () => {
  ...
  const [gpayno, setGpayno] = useState("");
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                  ...
                  >
                    ...
                    <option value="Meezan Bank">SBI</option>
                    <option value="UBL">HDFC</option>
                    <option value="HBL">PNB</option>
                    <option value="Allied Bank">YUKO BANK</option>
                  </select>
                  <input
                    type="text"
     ...
     =             gpay And Paypal Details
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                  <input
                    ...
                    value={gpayno}
                    placeholder="Gpay no"
                    onChange={(e) => setGpayno(e.target.value)}
                    className="text-[16px] py-2 bg-transparent border-b-[1px] border-b-stone-500 focus:outline-none sm:flex-1"
                    disabled={role === "Bidder"}
                  />
                  <input
